export const extractKey = function (item, KeySchema) {
...
export const parseKey = function (keys, table) {
...
export const extractKeysForItems = function (Items) {
  const keys = new Set();
...
export function doSearch(
  ...
  const getNextBite = (params, nextKey = null) => {
    ...
    return readMethod(params).then((data) => {
